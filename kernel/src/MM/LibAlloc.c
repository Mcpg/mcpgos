...
#define VERSION 	"1.1"
#define ALIGNMENT	4096ul//4ul				///< This is the byte alignment that memory must be allocated on. IMPORTANT for GTK and other stuff.

#define ALIGN_TYPE		uint8_t ///unsigned char[16] /// unsigned short
